; ==================================================================
; The Malaquias Operating System bootloader
;
; Based on a free boot loader by E Dehling. It scans the FAT12
; floppy for KERNEL.BIN (the Malaquias OS kernel), loads it and executes it.
...
OEMLabel		db "MALABOOT"	; Disk label
...
VolumeLabel		db "MALAQUIASOS"; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; Malaquias OS kernel filename
