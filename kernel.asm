; ==================================================================
; Malaquias OS -- The Malaquias Operating System kernel
;
...
; ==================================================================
	...
	%DEFINE MALAOS_VER '4.5'	; OS version number
	%DEFINE MALAOS_API_VER 15	; API version for programs to check
...
os_main:
	...
	mov es, ax			; segments ever again, as MALAOS and its programs
...
option_screen:
	...
	mov cx, 10011111b		; Colour: 1111 white text on 1001 light blue
	...
	os_init_msg		db 'Welcome to Malaquias OS', 0
	os_version_msg		db 'Version ', MALAOS_VER, 0

	dialog_string_1		db 'Thanks for trying out Malaquias OS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute Malaquias OS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of Malaquias OS, and', 0
