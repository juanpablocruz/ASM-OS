; ------------------------------------------------------------------
; Minicom-like program for Malaquias OS
; ------------------------------------------------------------------
...
;
; Connect the serial cable to your Malaquias OS machine and Linux machine.
; Start Malaquias OS and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the Malaquias OS machine, you will see a
...
erase_sub:
	...
	start_msg	db 'Malaquias OS minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting Malaquias OS minicom; press a key to return to Malaquias OS', 13, 10, 0
