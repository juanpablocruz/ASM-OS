; ------------------------------------------------------------------
; Simple file manager for Malaquias OS: copy, delete and rename files
; ------------------------------------------------------------------
	...
	; This is the point used by the disk buffer in the Malaquias OS kernel
...
.draw_background:
	...
	.title_msg		db 'Malaquias OS File Manager', 0
