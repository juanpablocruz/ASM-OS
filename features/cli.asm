...
echo_sentence:
	...
	cmp ax, 0		; Was an argument provided?
	jne .text_provided
	
	mov si, noargument_msg
	call os_print_string
	jmp get_cmd
...
; ------------------------------------------------------------------
	...
	help_text		db 'Commands: LS, COPY, REN, DEL, CAT, ECHO, SIZE, CLS, HELP, TIME, DATE, VER, EXIT, RESTART, SHUTDOWN', 13, 10, 0
	...
	noargument_msg	db 'No arguments provided', 13,10,0
	
	version_msg		db 'Malaquias OS ', MALAOS_VER, 13, 10, 0
